...
#
LIBS = -lSDL2 -lSDL2_mixer -lSDL2_image -lSDL2_ttf -lm
#
...
SDL_INC_PATH += $(addsufix /include,$(SDL_PATHS))
...
#
$(EXEC): $(OBJ_FILES)
	$(COMPILER) -o $@ $^ $(LINK_PATH) $(LIBS) $(FLAG)
...
ifeq ($(OS), Windows_NT)
	...
	@echo - debug:   Builds the release version
